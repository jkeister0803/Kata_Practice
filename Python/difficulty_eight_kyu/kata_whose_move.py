...
def whose_move(last_player, win):
    other_player = "black" if last_player == "white" else "white"

    return last_player if win else other_player


# Test:
print(whose_move("black", False))  # Should return "white"
print(whose_move("white", False))  # Should return "black"
print(whose_move("black", True))  # Should return "black"
print(whose_move("white", True))  # Should return "white"
